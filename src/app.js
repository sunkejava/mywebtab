...
function openSettings(){
  ...
  $("#modalBody").addEventListener("click",async e=>{const theme=e.target.closest("[data-theme]")?.dataset.theme;const wallpaper=e.target.closest("[data-wallpaper]")?.dataset.wallpaper;if(theme){state.settings.theme=theme;state.settings.wallpaper="";state.settings.customBackground="";await persist();applyAppearance();openSettings();}if(wallpaper){state.settings.wallpaper=wallpaper;state.settings.customBackground="";await persist();applyAppearance();openSettings();}});
