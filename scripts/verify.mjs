...
for (const host of ["http://wp.birdpaper.com.cn/*", "https://api.nguaduot.cn/*", "https://haowallpaper.com/*"]) if (!manifest.host_permissions.includes(host)) throw new Error(`${host} 权限缺失`);
